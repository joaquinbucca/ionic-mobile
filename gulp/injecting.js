...
// inject www/**/*.js, bower components, css into index.html
...
gulp.task('styles', ['clean'], function () {
  ...
  return gulp.src('www/*/styles/!(_)*.scss')
    .pipe($.plumber())
...
gulp.task('environment', function () {
  return gulp.src('www/*/constants/*config-const.js')
    .pipe(
      $.inject(
        gulp.src('www/main/constants/env-' + options.env + '.json'),
        {
          starttag: '/*inject-env*/',
          endtag: '/*endinject*/',
